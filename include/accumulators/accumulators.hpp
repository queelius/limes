...
// Kahan-Babuška accumulator with error compensation
template<Field T>
...
template<Field T>
constexpr auto make_simple() { return simple_accumulator<T>{}; }

template<Field T>
constexpr auto make_kahan() { return kahan_accumulator<T>{}; }

template<Field T>
constexpr auto make_neumaier() { return neumaier_accumulator<T>{}; }

template<Field T>
constexpr auto make_klein() { return klein_accumulator<T>{}; }
